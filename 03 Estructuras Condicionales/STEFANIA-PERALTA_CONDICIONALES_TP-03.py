...
contrasena = input("Ingresa contraseña entre 8 y 14 caracteres ")
lengContrasena = len (contrasena)

if lengContrasena >=8 and lengContrasena <= 14:
...
if media == mediana == moda:
    ...
    print("No cumple con las condiciones de sesgo")
...
lengFrase = len (frase)
ultimoDigito = (frase[lengFrase-1:]).lower()
if ultimoDigito == "a" or ultimoDigito == "e" or ultimoDigito == "i" or ultimoDigito == "o" or ultimoDigito == "u":
    print(f"{frase} !")
else:
    print(frase)
...
if (mes >= 1 and mes <= 12) and (dia >= 1 and dia <= 31):
    ...
    if hemisferio == "N":
        ...
        print("Hemisferio no válido. Debe ingresar 'N' (norte) o 'S' (sur).")
